...
export default function EventDetailUserPage() {
  const players = [
    ...
    { id: 4, name: "You", level: 3.0, img: "https://i.pravatar.cc/48?img=14" },
  ];
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-start justify-between">
              ...
              {/* Confirmed Badge */}
              <div
                className="px-3 py-1 rounded-full flex-shrink-0 mt-1"
                style={{ background: "#9FE870" }}
              >
                <span
                  className="text-[10px] font-semibold text-[#2F6C00]"
