...
export default function EventDetailRequestedPage() {
  return (
    <div className="min-h-screen bg-white max-w-[448px] mx-auto relative flex flex-col">
        ...
        >
          ...
          >
            ...
            >
              ...
              play for 90 minutes and usually grab a coffee after. Bring your
              own racket or rent one at the front desk.
            </p>
          </div>
      ...
      {/* Footer - Exit Game Button (red, since already requested) */}
      <div
      ...
      >
        <button
          className="w-full text-base font-normal text-white rounded-full relative overflow-hidden"
          style={{
            background: "#BA1A1A",
            height: "56px",
            lineHeight: "24px",
