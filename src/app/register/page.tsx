        ...
        <div className="w-full bg-white border border-[#F4F4F5] rounded-[32px] p-10 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-6 pb-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white border border-[#C1CAB5] rounded-xl py-[17px] pl-12 pr-4 text-sm text-[#151C27] placeholder-[#6B7280] outline-none focus:border-[#9FE870] transition-colors"
                />
            ...
            <div className="flex items-start gap-3 px-2">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 accent-[#9FE870] cursor-pointer"
              />
              <label
                htmlFor="terms"
            ...
            {/* CTA Button */}
            <button
              className="w-full bg-[#151C27] text-[#9FE870] rounded-full py-4 flex items-center justify-center gap-2 font-semibold text-base"
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative bg-white px-4">
              <span className="text-xs text-[#5D5F5F]">OR SIGN UP WITH</span>
            </div>
          </div>
