      ...
      >
        ...
        <div className="flex flex-col gap-3 px-6 pb-8 pt-4">
          ...
          <button
            ...
            className="flex items-center gap-3 w-full rounded-2xl p-4 text-left disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
              background: "#FFFFFF",
              border: "1px solid #F4F4F5",
              boxShadow: "0px 1px 2px 0px rgba(0,0,0,0.05)",
          ...
          >
            ...
            <span className="text-base font-semibold text-[#151C27]">
